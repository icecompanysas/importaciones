...
export default function Home() {
  ...
  return (
    <div className="bg-white mx-auto p-2 font-poppins">
      ...
      {isMenuOpen && (
        <div className="fixed inset-0 z-50 bg-gray-800 bg-opacity-90 flex flex-col items-center justify-center">
          <button onClick={toggleMenu} className="absolute top-4 right-4 text-white text-2xl font-bold">
            X
          </button>
          <ul className="menu flex flex-col space-y-4 text-center">
